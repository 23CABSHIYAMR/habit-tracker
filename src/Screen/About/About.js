  ...
  return (
    <Layout>
      <div className="w-full overflow-auto">
        ...
        after:absolute after:-bottom-1 after:left-0 after:rounded-lg after:w-[10%]
         sm:after:w-[20%] md:after:w-[20%] lg:after:w-[10%] tiny:after:w-[20%] after:h-[6px] after:bg-yellow1"
          >
            About Me
          </h2>
        </header>
